...
public class OfferHttpClientIntegrationTest {
    ...
    @RegisterExtension
    public static WireMockExtension wireMockServer = WireMockExtension.newInstance().options(wireMockConfig().dynamicPort())
            .build();

    OfferFetching remoteOfferClient = new OfferHttpClientTestConfig().remoteOfferTestClient(wireMockServer.getPort(), 1000, 1000);
